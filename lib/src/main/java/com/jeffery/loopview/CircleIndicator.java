...
public class CircleIndicator extends View {
    ...
    public void setViewPager(final ViewPager viewPager, int count) {
...
//        });
     ...
     */
    protected void trigger(int position, float positionOffset) {
